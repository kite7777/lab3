...
def get_detailed_post(userID: int):
    # Step 1: Get all posts by the given userID
    posts = get_posts()
    ...
    # Step 2: Loop through each post, fetch its comments, and format the data
    for post in user_posts:
        ...
        # Format the post and its associated comments
